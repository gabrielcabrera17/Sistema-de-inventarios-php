...
<!-- en la siguiente acción procesaremos lo que es el almacenamiento de datos
Se agrega el atributo enctype para poder enviar imagenes mediante el metodo post -->
		  	...
		  	<div class="column">
		    	...
		    	<div class="select is-rounded">
				  	<select name="producto_categoria" >
                        ...
                        <!-- solamente cuando la categoria sea mayor  a 0 se mostrara el opciòn-->
