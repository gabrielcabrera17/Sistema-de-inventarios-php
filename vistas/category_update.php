...
<!-- form-rest: aqui mostramos la respuesta donde se procesan los datos, cuando enviamos este formulario via ajaz-->
	<div class="form-rest mb-6 mt-6"></div>


	<form action="./php/categoria_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >

		<input type="hidden" name="categoria_id" value="<?php echo $datos
